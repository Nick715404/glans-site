...
export const Flowers = () => {
  return (
    <>
      ...
      <div className="absolute bottom-[32rem] -left-[15rem] scale-[1.4] pointer-events-none z-10 2xl:-left-[20rem] xl:scale-[1.2] md:scale-[0.6] md:top-[35rem] md:-left-[22rem]">
      ...
      <div className="absolute top-[43rem] -right-[18rem] scale-[2] pointer-events-none z-10 2xl:-right-[25rem] xl:scale-[1.7] md:scale-[0.6] md:top-[29rem] md:-right-[20rem]">
